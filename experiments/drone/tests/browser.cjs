...
(async()=>{
  ...
  try{
    ...
    await page.selectOption('#controller','vision');await page.selectOption('#scenario','forest');
    ...
    console.log('Browser checks passed: subpath hosting, real worker, looming, ablation, flight, pause, CSV and mobile layout.');
